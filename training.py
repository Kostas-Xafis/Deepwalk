...
for w_size, w_len, n_walks, emb_dim in itertools.product(
      param_grid["window_size"],
      param_grid["walk_length"],
      param_grid["num_walks"],
      param_grid["embedding_dim"]
):
      print("Current configuration: window_size:", w_size, "walk_length:", w_size+w_len, "num_walks:", n_walks, "embedding_dim:", emb_dim)
